const tasks = {};  //contains all the individual task objects
...
addTaskBtn.addEventListener("click", () => {
    ...
    taskItems.forEach((taskItem) => {
        ...
        updateTable();  // add a new row to the table with the new task.
    });
...
const updateTable = () => {
    let item = tasks[String(latestIndex)]; //get the latest task from the tasks object
